...
const Swirls = () => (
  <>
    <svg
      className="absolute top-0 left-0 -translate-x-1/3 -translate-y-1/3 text-orange-100 dark:text-orange-950/20 pointer-events-none"
      width="600"
      height="600"
      viewBox="0 0 600 600"
      fill="none"
    ...
    <svg
      className="absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4 text-orange-100 dark:text-orange-950/20 pointer-events-none"
      width="700"
      height="700"
      viewBox="0 0 700 700"
      fill="none"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 container mx-auto px-4 text-center max-w-2xl">
        <h1 className="text-4xl font-bold tracking-tight text-stone-900 sm:text-5xl md:text-6xl font-heading">
          {title}
        </h1>
